---
url: "https://documentation.justbeep.it/~/revisions/quuEkY4Lk3bJbnZ3siEN/product-overview/beep-pay"
...
- [Developer guide](https://documentation.justbeep.it/~/revisions/quuEkY4Lk3bJbnZ3siEN/product-overview/beep-pay/developer-guide)
- [zero fee settlement flow](https://documentation.justbeep.it/~/revisions/quuEkY4Lk3bJbnZ3siEN/product-overview/beep-pay/zero-fee-settlement-flow)
...
- [Accept payments using Beep Pay](https://documentation.justbeep.it/~/revisions/quuEkY4Lk3bJbnZ3siEN/product-overview/beep-pay#accept-payments-using-beep-pay)
- [⚡ Why Use Beep Pay?](https://documentation.justbeep.it/~/revisions/quuEkY4Lk3bJbnZ3siEN/product-overview/beep-pay#why-use-beep-pay)
...
### [Direct link to heading](https://documentation.justbeep.it/~/revisions/quuEkY4Lk3bJbnZ3siEN/product-overview/beep-pay\#accept-payments-using-beep-pay)    Accept payments using Beep Pay
...
### [Direct link to heading](https://documentation.justbeep.it/~/revisions/quuEkY4Lk3bJbnZ3siEN/product-overview/beep-pay\#why-use-beep-pay)    ⚡ Why Use Beep Pay?
...
#### [Direct link to heading](https://documentation.justbeep.it/~/revisions/quuEkY4Lk3bJbnZ3siEN/product-overview/beep-pay\#example-use-cases)    Example Use Cases
...
[PreviousFAQs](https://documentation.justbeep.it/~/revisions/quuEkY4Lk3bJbnZ3siEN/product-overview/agentic-yield/faqs) [NextDeveloper guide](https://documentation.justbeep.it/~/revisions/quuEkY4Lk3bJbnZ3siEN/product-overview/beep-pay/developer-guide)
