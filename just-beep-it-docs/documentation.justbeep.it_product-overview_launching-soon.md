---
url: "https://documentation.justbeep.it/product-overview/launching-soon"
title: "Launching soon | Beep | Agentic Finance Protocol for AI Payments, A2A Commerce, and Yield on SUI"
---
...
1. Accrue agentic yield \[ _redacted_\]

2. Agentic yield token support expanded to **SUI, suiUSDe, xBTC, Walrus**

3. Additional Agentic yield strategies



1. Delta neutral (upto 25% APY)

2. Liquid leverage (upto 35% APY)


4. A2A payments: Integration expanded to support Google's AP2

5. on-chain "credit" for agents

6. buy now pay never - yield funded purchases


[PreviousLegal](https://documentation.justbeep.it/product-overview/resources/legal)
