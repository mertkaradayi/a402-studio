---
url: "https://documentation.justbeep.it/~/revisions/quuEkY4Lk3bJbnZ3siEN/product-overview/agentic-yield/why-should-i-use-beeps-agentic-yield"
title: "why should I use beep's agentic yield? | Beep | Agentic Finance Protocol for AI Payments, A2A Commerce, and Yield on SUI"
---
...
- [🧠 What It Actually Does](https://documentation.justbeep.it/~/revisions/quuEkY4Lk3bJbnZ3siEN/product-overview/agentic-yield/why-should-i-use-beeps-agentic-yield#what-it-actually-does)
- [💸 Why It’s Better](https://documentation.justbeep.it/~/revisions/quuEkY4Lk3bJbnZ3siEN/product-overview/agentic-yield/why-should-i-use-beeps-agentic-yield#why-its-better)
...
### [Direct link to heading](https://documentation.justbeep.it/~/revisions/quuEkY4Lk3bJbnZ3siEN/product-overview/agentic-yield/why-should-i-use-beeps-agentic-yield\#what-it-actually-does)    🧠 What It Actually Does

Beep’s Agentic Yield deploys an **ai-agent** that runs on-chain 24/7 — scanning, scoring, and reallocating your capital whenever a better opportunity appears.
No dashboards to refresh. No bridging gymnastics. No human babysitting.
...
You keep custody of funds the entire time using your keys

* * *

### [Direct link to heading](https://documentation.justbeep.it/~/revisions/quuEkY4Lk3bJbnZ3siEN/product-overview/agentic-yield/why-should-i-use-beeps-agentic-yield\#why-its-better)    💸 Why It’s Better

- **No manual chasing** — your agent sees every on-chain opportunity before you do.

- **Zero custody risk** — funds live in your own wallet, not a shared pool.
...
[Previouswhat is agentic yield?](https://documentation.justbeep.it/~/revisions/quuEkY4Lk3bJbnZ3siEN/product-overview/agentic-yield/what-is-agentic-yield) [Nextcore concepts](https://documentation.justbeep.it/~/revisions/quuEkY4Lk3bJbnZ3siEN/product-overview/agentic-yield/core-concepts)
