---
url: "https://documentation.justbeep.it/product-overview/agentic-yield/faqs"
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agentic-yield/faqs\#what-is-agentic-yield)    What is Agentic Yield?
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agentic-yield/faqs\#how-does-it-work)    How does it work?
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agentic-yield/faqs\#what-we-do-not-do)    What we do not do
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agentic-yield/faqs\#putting-it-all-together)    Putting it all together
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agentic-yield/faqs\#is-your-wallet-platform-non-custodial)    Is your wallet platform non-custodial?
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agentic-yield/faqs\#how-can-i-manage-my-keys)    How can I manage my keys?
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agentic-yield/faqs\#settlement-blockchain)    Settlement blockchain
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agentic-yield/faqs\#stablecoins-usdc-on-sui)    Stablecoins: USDC on Sui
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agentic-yield/faqs\#what-3rd-parties-are-you-using-for-self-custodial-wallet-infra-and-bridge-infra)    What 3rd parties are you using for self-custodial wallet infra and bridge infra?
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agentic-yield/faqs\#where-does-the-yield-come-from)    Where does the yield come from?
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agentic-yield/faqs\#multi-chain-interactions)    Multi-chain interactions
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agentic-yield/faqs\#do-i-keep-custody-of-my-funds)    Do I keep custody of my funds?
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agentic-yield/faqs\#can-the-agent-move-my-tokens-somewhere-unsafe)    Can the agent move my tokens somewhere unsafe?
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agentic-yield/faqs\#what-if-a-protocol-gets-hacked-or-loses-liquidity)    What if a protocol gets hacked or loses liquidity?
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agentic-yield/faqs\#how-often-does-my-agent-rebalance)    How often does my agent rebalance?
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agentic-yield/faqs\#are-there-any-fees)    Are there any fees?
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agentic-yield/faqs\#what-tokens-and-networks-are-supported)    What tokens and networks are supported?

Right now: **USDC on SUI**.
Coming soon: **others.**
Multi-chain strategies across BASE and SOL networks are in active testing.

#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agentic-yield/faqs\#how-does-the-agent-decide-which-protocol-to-use)    How does the agent decide which protocol to use?
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agentic-yield/faqs\#can-i-customize-behavior)    Can I customize behavior?
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agentic-yield/faqs\#can-i-withdraw-anytime)    Can I withdraw anytime?
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agentic-yield/faqs\#is-your-smart-contract-deployed-on-chain)    Is your smart contract deployed on chain?
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agentic-yield/faqs\#do-you-have-3rd-party-security-audits)    Do you have 3rd party security audits?
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agentic-yield/faqs\#will-you-open-source-your-code)    Will you open source your code?

No, we are not an open source project.

[Previoussecurity](https://documentation.justbeep.it/product-overview/agentic-yield/security) [NextBeep Pay](https://documentation.justbeep.it/product-overview/beep-pay)
