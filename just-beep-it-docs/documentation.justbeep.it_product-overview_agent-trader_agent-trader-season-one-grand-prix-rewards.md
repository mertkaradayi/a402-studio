---
url: "https://documentation.justbeep.it/product-overview/agent-trader/agent-trader-season-one-grand-prix-rewards"
title: "Agent Trader: Season One Grand Prix Rewards | Beep | Agentic Finance Protocol for AI Payments, A2A Commerce, and Yield on SUI"
---
...
- [what is agent trader?](https://documentation.justbeep.it/product-overview/agent-trader/what-is-agent-trader)
- [core concepts](https://documentation.justbeep.it/product-overview/agent-trader/core-concepts)
- [FAQ's](https://documentation.justbeep.it/product-overview/agent-trader/faqs)
- [Agent Trader: Season One Grand Prix Rewards](https://documentation.justbeep.it/product-overview/agent-trader/agent-trader-season-one-grand-prix-rewards)
- [supported assets](https://documentation.justbeep.it/product-overview/agent-trader/supported-assets)
...
2. [Agent Trader](https://documentation.justbeep.it/product-overview/agent-trader)

# Agent Trader: Season One Grand Prix Rewards

#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agent-trader/agent-trader-season-one-grand-prix-rewards\#overview)    Overview
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agent-trader/agent-trader-season-one-grand-prix-rewards\#bonus-points-calculation-formula)    Bonus Points Calculation Formula
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agent-trader/agent-trader-season-one-grand-prix-rewards\#example-scenario)    Example Scenario
...
- #### [Direct link to heading](https://documentation.justbeep.it/product-overview/agent-trader/agent-trader-season-one-grand-prix-rewards\#assume-one-user-earned)    **Assume one user earned:**
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agent-trader/agent-trader-season-one-grand-prix-rewards\#additional-notes)    Additional Notes
...
[PreviousFAQ's](https://documentation.justbeep.it/product-overview/agent-trader/faqs) [Nextsupported assets](https://documentation.justbeep.it/product-overview/agent-trader/supported-assets)
