---
url: "https://documentation.justbeep.it/product-overview/agent-trader/core-concepts"
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agent-trader/core-concepts\#high-level-architecture)    High-level architecture

The architecture of Agent Trader is organized into several key layers, each responsible for distinct functions:

#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agent-trader/core-concepts\#inputs)    Inputs
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agent-trader/core-concepts\#agent-brain-decision-loop)    Agent brain (decision loop)
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agent-trader/core-concepts\#execution-layer)    Execution layer
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agent-trader/core-concepts\#risk-and-policy-layer)    Risk & policy layer
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agent-trader/core-concepts\#ux-layer)    UX layer
...
#### [Direct link to heading](https://documentation.justbeep.it/product-overview/agent-trader/core-concepts\#beep-bluefin-integration)    Beep × Bluefin integration
...
[Previouswhat is agent trader?](https://documentation.justbeep.it/product-overview/agent-trader/what-is-agent-trader) [NextFAQ's](https://documentation.justbeep.it/product-overview/agent-trader/faqs)
