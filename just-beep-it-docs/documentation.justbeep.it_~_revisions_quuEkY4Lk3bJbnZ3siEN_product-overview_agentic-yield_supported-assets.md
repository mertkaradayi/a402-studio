---
url: "https://documentation.justbeep.it/~/revisions/quuEkY4Lk3bJbnZ3siEN/product-overview/agentic-yield/supported-assets"
title: "supported assets | Beep | Agentic Finance Protocol for AI Payments, A2A Commerce, and Yield on SUI"
---
...
Agentic Yield currently supports **USDC** — the most widely adopted and liquid stablecoin in the Sui ecosystem. Your agent can deposit, earn, and compound yield directly on-chain using USDC

We’re actively expanding support to more assets within the Sui DeFi stack, we will announce when the new assets are launched including:
...
> **\*\*Note:** Multi-asset basket optimization (USDC + SUI + Walrus + xBTC) is already live in internal testing. Public rollout is planned for the next month launch update.

[Previousstart earning yield](https://documentation.justbeep.it/~/revisions/quuEkY4Lk3bJbnZ3siEN/product-overview/agentic-yield/start-earning-yield) [Nextsecurity](https://documentation.justbeep.it/~/revisions/quuEkY4Lk3bJbnZ3siEN/product-overview/agentic-yield/security)
